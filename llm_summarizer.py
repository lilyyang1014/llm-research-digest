...
class LLMSummarizer:
    ...
    def _initialize_client(self):
        ...
        if not self.config.GOOGLE_API_KEY or self.config.GOOGLE_API_KEY == "****":
            ...
            # We exit here because without the client, this class is useless.
            sys.exit(1)
        try:
    ...
    def process_text(self, paper_text):
        """
        ...
        try:
            ...
            # Preserving the exact API call from the original script
